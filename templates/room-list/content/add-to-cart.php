...
$add_to_cart_button_class = htl_uncode_get_button_classes( $shortcode_atts, 'listing_buttons' );
?>
...
<div class="add-to-cart-wrapper">
	...
	<?php if ( $available_rooms > 0 && $is_available && apply_filters( 'hotelier_show_add_to_cart_button', true, $room, $checkin, $checkout ) ) : ?>
		...
		<a href="#reserve-button" data-selected-text-singular="<?php echo esc_attr_x( 'room selected', 'book now button text: singular', 'wp-hotelier' ); ?>" data-selected-text-plural="<?php echo esc_attr_x( 'rooms selected', 'book now button text: plural', 'wp-hotelier' ); ?>" class="button button--add-to-cart <?php echo esc_attr( implode( ' ', $add_to_cart_button_class ) ); ?>"><?php esc_html_e( 'Book now', 'wp-hotelier' ); ?></a>
