...
$layout['room_price'] = array('no_text', 'inline');
$layout['room_details'] = array('adults_with_icon', 'children_with_icon', 'bed_size_with_icon', 'room_size_with_icon');
$layout['category'] = array('nobg', 'topleft');
